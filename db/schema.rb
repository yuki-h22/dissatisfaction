...
ActiveRecord::Schema.define(version: 2020_01_15_083005) do
  ...
  create_table "empathies", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "bitch_id"
    t.index ["bitch_id"], name: "index_empathies_on_bitch_id"
  ...
  create_table "users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "sort_status"
    t.index ["email"], name: "index_users_on_email", unique: true
    t.index ["reset_password_token"], name: "index_users_on_reset_password_token", unique: true
  end

  add_foreign_key "empathies", "bitches"
end
